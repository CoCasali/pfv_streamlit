...
if uploaded_file is not None:
    data = pd.read_excel(uploaded_file, sheet_name = "DATA_CALC",header=1, engine = 'openpyxl', mode = 'a')
    data2 = pd.read_excel(uploaded_file, sheet_name = "DEMI_CYCLES", engine = 'openpyxl', mode = 'a')
